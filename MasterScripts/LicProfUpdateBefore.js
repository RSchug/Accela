/*------------------------------------------------------------------------------------------------------/
| Program : LicProfUpdateBefore.js
| Event   : LicProfUpdateBefore
|
...
/------------------------------------------------------------------------------------------------------*/
var controlString = "LicProfUpdateBefore"; // Standard choice for control
...
var licProfObject = aa.env.getValue("licenseProfessionalObjFromEvent");
logDebug("licProfObject = " + licProfObject.getClass());

var CAEAtts = aa.env.getValue("licProfAttributeFromEvent");
for (ca in CAEAtts)
