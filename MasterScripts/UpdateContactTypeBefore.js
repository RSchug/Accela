/*------------------------------------------------------------------------------------------------------/
| Program : UpdateContactTypeBeforeV.js
...
| Action# : N/A
|
| Notes   : Similar to the universal master script, but return code handling is unusual for this event
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
| <===========END=Main=Loop================>
/-----------------------------------------------------------------------------------------------------*/
//NOTE: This event inexplicably requires a return code of -1 to cancel instead of 1; just go with it
if(eventType == "After"){
