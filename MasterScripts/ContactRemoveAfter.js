/*------------------------------------------------------------------------------------------------------/
| Program : ContactRemoveAfterv.js
| Event   : ContactRemoveAfter
|
...
/------------------------------------------------------------------------------------------------------*/
var controlString = "ContactRemoveAfter"; // Standard choice for control
...
/------------------------------------------------------------------------------------------------------*/
var contactNbr = aa.env.getValue("ContactNbr"); logDebug("contactNbr = " + contactNbr);
/*
*NOT AVAILABLE TO EVENT
var ContactObj = aa.env.getValue("Contact");			logDebug("ContactObj = " + ContactObj.getClass());
var ContactAttrObj = aa.env.getValue("ContactAttribute");	logDebug("ContactAttrObj = " + ContactAttrObj.getClass());
