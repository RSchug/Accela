/*------------------------------------------------------------------------------------------------------/
| Program : ApplicationSpecificInfoUpdateBefore.js
...
/------------------------------------------------------------------------------------------------------*/
var controlString = "ApplicationSpecificInfoUpdateBefore"; // Standard choice for control
...
loadASITablesBefore(aa.env.getValue("AppSpecificTableGroupModel"));
var AppSpecificInfoModels = aa.env.getValue("AppSpecificInfoModels");

for (loopk in AppSpecificInfoModels)
	{
	if (useAppSpecificGroupName)
		AInfo[AppSpecificInfoModels[loopk].getCheckboxType() + "." + AppSpecificInfoModels[loopk].checkboxDesc] = AppSpecificInfoModels[loopk].checklistComment;
	else
		AInfo[AppSpecificInfoModels[loopk].checkboxDesc] = AppSpecificInfoModels[loopk].checklistComment;
	}
