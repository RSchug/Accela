/*------------------------------------------------------------------------------------------------------/
| Program : ExternalDocReviewCompletedV.js
| Event   : ExternalDocReviewCompleted
|
...
/------------------------------------------------------------------------------------------------------*/
var checkedInDocModelArray = aa.env.getValue("CheckedinDocuments"); 
if (checkedInDocModelArray && checkedInDocModelArray.length > 0) {
	logDebug("checkedInDocModelArray ("+ checkedInDocModelArray.length + " docs");
}
var previousDocID  = aa.env.getValue("PreviousDocID").toString();  logDebug("previousDocID = " + previousDocID);

if (previousDocID) {
	var result = aa.document.getDocumentByPK(previousDocID);
	if(result.getSuccess())	{
		var previousDocModel  = result.getOutput();
		if(previousDocModel) {
			logDebug("previousDocModel = " + previousDocModel);
		}
	}
}
/*------------------------------------------------------------------------------------------------------/
