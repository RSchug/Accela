/*------------------------------------------------------------------------------------------------------/
| Program : ApplicationConditionAddAfterV.js
...
/------------------------------------------------------------------------------------------------------*/
var controlString = "ApplicationConditionAddAfter" 			// Standard choice for control
...
var conditionTempalte = null;
if(templateObj != null && templateObj != ""){
	conditionTemplate = genericTemplateObject(templateObj);
}
