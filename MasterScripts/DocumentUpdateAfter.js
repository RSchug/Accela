/*------------------------------------------------------------------------------------------------------/
| SVN $Id: DocumentUpdateAfter.js 3885 2014-06-04 16:39:51Z john.schomp $
| Program : DocumentUpdateAfterv.js
| Event   : DocumentUpdateAfter
|
...
var controlString = "DocumentUpdateAfter";        // Standard choice for control
...
var templateObj = aa.env.getValue("Template");
...
| BEGIN Event Specific Variables
/------------------------------------------------------------------------------------------------------*/
logDebug("documentModel = " + documentModel);
logDebug("templateObj = " + templateObj);
